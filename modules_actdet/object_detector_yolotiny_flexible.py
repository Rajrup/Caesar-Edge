...
YOLO_MODEL = '/home/yitao/Documents/fun-project/tensorflow-related/Caesar-Edge/cfg/tiny-yolo-voc.cfg'
# YOLO_WEIGHTS = '/home/yitao/Documents/fun-project/tensorflow-related/Caesar-Edge/checkpoints/yolo/yolo.weights'
YOLO_WEIGHTS = '/home/yitao/Downloads/tmp/docker-share/module_actdet/checkpoints/yolotiny/tiny-yolo-voc.weights'
...
class ActDetYoloTiny:
    ...
    def Setup():
        ...
        ActDetYoloTiny.tfnet = TFNet(opt)
    ...
    def Apply(self):
        ...
        self.dets = ActDetYoloTiny.tfnet.return_predict(self.image, "actdet_yolotiny", self.istub)
